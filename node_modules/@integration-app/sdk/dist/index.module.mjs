...
class RateLimitExceededError extends BadRequestError {
    constructor(arg) {
        super(arg);
        this.data.key = BadRequestErrorKey.RATE_LIMIT_EXCEEDED;
    }
}
...
function getFormulas() {
    return {
        ...
        [DataBuilderFormulaType.FIND_EXTERNAL_RECORD_ID]: DataBuilderFormulaFindExternalRecordId,
        [DataBuilderFormulaType.FIND_APP_RECORD_ID]: DataBuilderFormulaFindAppRecordId,
        ...
        [DataBuilderFormulaType.FIRST_NOT_EMPTY]: FirstNotEmpty,
        [DataBuilderFormulaType.DOMAIN_FROM_EMAIL]: DomainFromEmail,
        [DataBuilderFormulaType.FORMULA]: FormulaFormula,
        [DataBuilderFormulaType.JSONATA]: JsonataFormula,
        [DataBuilderFormulaType.DATA_SCHEMA_REF]: DataSchemaRef,
    };
}
...
function processCopy(data) {
    ...
    for (const locator of copyLocators) {
        ...
        const valueHasCopy = getFormulaLocators(DataBuilderFormulaType.COPY, valueToCopy).length > 0;
        if (valueHasCopy) {
...
class And extends DataBuilderFormulaBase {
    constructor(args) {
        super(DataBuilderFormulaType.AND, args);
    }
    getValue(variables) {
...
class DataField {
    constructor(data) {
        ...
        this.name = (_b = (_a = this.name) !== null && _a !== void 0 ? _a : this.schema.title) !== null && _b !== void 0 ? _b : toHeaderCase(this.key);
...
const ConnectorEventImplementationType$1 = {
    methods: {
                ...
                events: {
                    ...
                    items: {
                        ...
                        properties: {
                            type: {
                                type: 'string',
                                enum: Object.values(DataCollectionEventType),
                            },
...
const ConnectorDataCollectionEventImplementationType = {
    ...
    'connector-event': ConnectorEventImplementationType$1,
...
function isDataLocationMethodSupported(location, methodKey) {
    ...
    return (method &&
        method.implementationType !== ConnectorMethodImplementationType.notSupported);
}
...
class DomainFromEmail extends DataBuilderFormulaBase {
    constructor(value) {
        super(DataBuilderFormulaType.DOMAIN_FROM_EMAIL, value);
        this.value = value;
    }
    getValue(variables) {
...
class Eval extends DataBuilderFormulaBase {
    constructor(args, formulaValue) {
        super(DataBuilderFormulaType.EVAL, args);
        this.value = args;
...
class FirstNotEmpty extends DataBuilderFormulaBase {
    constructor(args) {
        super(DataBuilderFormulaType.FIRST_NOT_EMPTY, args);
    }
    getValue(variables) {
...
class FormulaFormula extends DataBuilderFormulaBase {
    constructor(args) {
        super(DataBuilderFormulaType.FORMULA, args);
    }
    getValue(variables) {
...
class JsonataFormula extends DataBuilderFormulaBase {
    constructor(expression) {
        super(DataBuilderFormulaType.JSONATA, expression);
...
class DataBuilderFormulaMap extends DataBuilderFormulaBase {
    constructor(args) {
        super(DataBuilderFormulaType.MAP, args);
        this.args = args;
    }
    getValue(variables) {
...
class MergeObjects extends DataBuilderFormulaBase {
    constructor(args) {
        super(DataBuilderFormulaType.MERGE_OBJECTS, args);
    }
    getValue(variables) {
...
class Or extends DataBuilderFormulaBase {
    constructor(args) {
        super(DataBuilderFormulaType.OR, args);
    }
    getValue(variables) {
        const args = processValue(this.args, variables);
        if (Array.isArray(args) &&
...
class DataBuilderFormulaPlain extends DataBuilderFormulaBase {
    constructor(value) {
        super(DataBuilderFormulaType.PLAIN, value);
        this.value = value;
    }
    getValue() {
        return this.value;
...
class DataBuilderFormulaRecord extends DataBuilderFormulaBase {
    constructor(record) {
        super(DataBuilderFormulaType.RECORD, record);
        this.record = record;
    }
    getValue() {
        var _a;
...
class DataSchemaRef extends DataBuilderFormulaBase {
    constructor(value) {
        super(DataBuilderFormulaType.DATA_SCHEMA_REF, value);
        this.value = value;
    }
    getValue() {
        return undefined;
...
function getFlowNodeTitle(flow, nodeKey) {
    ...
    return ((_e = (_c = (_b = (_a = node.ui) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : node.name) !== null && _c !== void 0 ? _c : (_d = FLOW_NODE_SPECS[node.type]) === null || _d === void 0 ? void 0 : _d.name) !== null && _e !== void 0 ? _e : toHeaderCase(nodeKey));
}
...
class DataForm {
    ...
    makeDataField(key, schema) {
        var _a;
        return {
            name: (_a = schema === null || schema === void 0 ? void 0 : schema.title) !== null && _a !== void 0 ? _a : toHeaderCase(key),
            locator: key,
            schema,
...
function externalEventTypeToDataCollectionEventType(type) {
    switch (type) {
        case ExternalEventType.DataRecordCreated:
            return DataCollectionEventType.CREATED;
        case ExternalEventType.DataRecordUpdated:
            return DataCollectionEventType.UPDATED;
        case ExternalEventType.DataRecordDeleted:
...
function dataCollectionEventTypeToExternalEventType(type) {
    switch (type) {
        case DataCollectionEventType.CREATED:
            return ExternalEventType.DataRecordCreated;
        case DataCollectionEventType.UPDATED:
            return ExternalEventType.DataRecordUpdated;
        case DataCollectionEventType.DELETED:
            return ExternalEventType.DataRecordDeleted;
        default:
...
function externalEventTypeToSubscriptionType(type) {
    switch (type) {
        case ExternalEventType.DataRecordCreated:
            return ExternalEventSubscriptionType.DataRecordCreated;
        case ExternalEventType.DataRecordUpdated:
            return ExternalEventSubscriptionType.DataRecordUpdated;
        case ExternalEventType.DataRecordDeleted:
            return ExternalEventSubscriptionType.DataRecordDeleted;
        case ExternalEventType.ConnectorEvent:
            return ExternalEventSubscriptionType.ConnectorEvent;
        default:
